...
| P1 | 领域模型与数据库 | 14 | 5-7h | 最高 | 未开始 |
| P2 | 认证与安全模块 | 10 | 4-5h | 最高 | 未开始 |
| P3 | 商城结构管理 | 10 | 4-5h | 高 | 未开始 |
| P4 | 区域权限管理 | 12 | 5-6h | 高 | 未开始 |
| P5 | 店铺与商品管理 | 8 | 3-4h | 中 | 未开始 |
| P6 | 布局版本管理 | 8 | 3-4h | 中 | 未开始 |
| P7 | 缓存与性能优化 | 8 | 3-4h | 低 | 未开始 |
| P8 | WebSocket 通知 | 10 | 3-4h | 低 | 未开始 |
| P9 | 集成测试与文档 | 6 | 2-3h | 低 | 未开始 |

**总计**: 约 94 个任务，预估 35-45 小时
...
- [ ] 1.1.1 创建强类型 ID
  - MallId、FloorId、AreaId、StoreId、ProductId
  - _Requirements: 领域模型_
...
- [ ] 1.1.3 创建枚举类型
  - AreaStatus、UserType、ApplyStatus、LayoutVersionStatus
  - _Requirements: 领域模型_
...
- [*] 4.5.2 编写权限校验单元测试
  - 区域权限、边界校验
  - _Requirements: 需求 5, Property 5, 6_
...
- [*] 6.4.1 编写版本管理单元测试
  - 版本发布、状态转换
  - _Requirements: 需求 9, Property 3, 10_
